from pee.melhor_prim.avaliador_custo_unif import AvaliadorCustoUnif
...
class ProcuraCustoUnif(ProcuraMelhorPrim):
    """Classe que implementa o mecanismo de procura melhor primeiro, para procura de custo uniforme.
       A procura de custo unifomr é uma procura de melhor primeiro, em que o no a expandir, ou seja,
